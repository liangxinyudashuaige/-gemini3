      ...
      if (video.currentTime !== lastVideoTime) {
        ...
        if (results.landmarks) {
          for (let i = 0; i < results.landmarks.length; i++) {
            ...
            // Note: MediaPipe mirrors handedness for selfie mode sometimes, assume Standard:
            // "Left" in handedness usually means Left hand in world space (User's left).
            ...
            // Update State Refs
            // Note: Handedness might need flipping depending on camera mirror settings. 
            // Usually MediaPipe Video mode: Left hand appears on Left side of screen if mirrored? 
            // Let's rely on categoryName.
